...
import {Text, View, StyleSheet, Image, ScrollView, TextInput, TouchableWithoutFeedback, Keyboard, ActivityIndicator, TouchableOpacity} from 'react-native';
    ...
    render () {
        return(
            <View style = {styles.container}>
                ...
                {this.state.holder ? 
                    this.renderHolder() : this.renderData()
                }
            </View>
        )
    }
